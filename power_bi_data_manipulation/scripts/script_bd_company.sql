...
create table departament IF NOT EXISTS(
...
create table dept_locations IF NOT EXISTS(
	Dnumber int not null,
...
create table works_on IF NOT EXISTS(
...
create table dependent IF NOT EXISTS(
	Essn char(9) not null,
